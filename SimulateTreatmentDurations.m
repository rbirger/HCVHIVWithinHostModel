function [t_out_n1,P_out_n1,t_out_l1,...
    ...
    SimulateTreatmentDurations(Tcstar,Icstar, Vcstar,Thstar,equil_index,params, shortdur,longdur, norm_sh, low_sh, highVL)

   %Function to simulate varying treatment durations for a given efficacy
   %under varying CD4 conditions
   ...
   %durations, HIV positive for long durations
        ...
        [t_out_n1, P_out_n1] = VLplot(Tcstar, Icstar,  Vcstar, Thstar,equil_index,params);
        ...
        params.sh = low_sh;
        params.tdur = shortdur;
        [t_out_l1, P_out_l1] = VLplot(Tcstar, Icstar,  Vcstar, Thstar,equil_index,params);
        
        % Set up parameters to test long duration in reduced CD4 patient 
        params.tdur = longdur;
      
        [t_out_l2, P_out_l2] = VLplot(Tcstar, Icstar,  Vcstar, Thstar,equil_index,params);
        ...
        [t_out_h1, P_out_h1] = VLplot(Tcstar, Icstar,  Vcstar, Thstar,equil_index,params);
