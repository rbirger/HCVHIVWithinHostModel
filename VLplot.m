function [t_out, P_out] = VLplot(Tcstar, Icstar,  Vcstar, Thstar,eq_index, params)

% Inputs: Equilibrium formulae of Target Cells, Infected Cells, Free  CD4 cells

% Output time and population vectors for standard version of model, given a set of
% parameters
...
if ~isempty(find(P0<0))
    ...
    [t_out, P_out] = ode23(@hcvhivThIcVc, [t0:tf], P0,options, params);
end
